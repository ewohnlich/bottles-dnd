    ...
    return (
        <>
            <NavDropdown title="JSON" id="json-dropdown">
                <NavDropdown.Item eventKey="export" onClick={handleShowExport}>Export</NavDropdown.Item>
                <NavDropdown.Item eventKey="import" onClick={handleShowImport}>Import</NavDropdown.Item>
            </NavDropdown>
...
export function Main() {
    const [prepared, setPrepared] = useState(JSON.parse(localStorage.getItem("dnd-prepared")) || []),
        boostProps = useState(JSON.parse(localStorage.getItem("dnd-boosts")) || defaultBoosts),
        [character, setCharacter] = useState(JSON.parse(localStorage.getItem("dnd-character")) || defaultCharacter),
        [proficiency, setProficieny] = useState(JSON.parse(localStorage.getItem("dnd-proficiencies")) || defaultSkills),
                    ...
                    <Nav
                        ...
                        <Nav.Item title="Character">
                            <Nav.Link eventKey="character"
                                      onClick={() => setSection('character')}>Character</Nav.Link>
                        </Nav.Item>
                        <Nav.Item title="Spells">
                            <Nav.Link eventKey="spells" onClick={() => setSection('spells')}>Spell
                                Casting</Nav.Link>
                        </Nav.Item>
                        <Nav.Item title="Spell Book">
                            <Nav.Link eventKey="spellbook" onClick={() => setSection('spellbook')}>Spell
                                Book</Nav.Link>
                        </Nav.Item>
                        <Nav.Item title="Basic">
                            <Nav.Link eventKey="basic" onClick={() => setSection('basic')}>Basic</Nav.Link>
                        </Nav.Item>
            ...
            <CharacterContext value={{character, setCharacter}}>
                ...
                <Container>
                    <Form>
                            ...
                            <Row>
                                <Col>
                                    <Form.Group>
                                        ...
                                        <Form.Label htmlFor="character-name">Character Name</Form.Label>
                                    </Form.Group>
                                </Col>
                                <Col>
                                    <Row>
                                        <Col>
                                            <CharacterClass character={character} setCharacter={setCharacter}/>
                                        </Col>
                                        <Col>
                                            <Subclass character={character} setCharacter={setCharacter}/>
                                        </Col>
                                        <Col>
                                            <CharacterLevel/>
                                    ...
                                    <Row>
                                        <Col>
                                            <Form.Group>
                                                ...
                                                <Form.Label htmlFor="character-race">Race</Form.Label>
                                            </Form.Group>
                                        </Col>
                                        <Col>
                                            <Form.Group>
                                                ...
                                                <Form.Label htmlFor="character-alignment">Alignment</Form.Label>
                                            </Form.Group>
                                        </Col>
                                        <Col>
                                            <Form.Group>
                                                <Form.Control
                                                    ...
                                                    value={character.xp}/>
                                                <Form.Label htmlFor="character-xp">Experience Points</Form.Label>
                                            </Form.Group>
                                        </Col>
                                    </Row>
                                </Col>
                        ...
                        <div id="character" className={`mb-4${section === "character" ? "" : " d-none"}`}>
                            <Character character={character} setCharacter={setCharacter}/>
                        </div>
                        <div id="spells" className={`mb-4${section === "spells" ? "" : " d-none"}`}>
                            <Spells character={character} prepared={prepared} boostProps={boostProps}/>
                        </div>
                        <div id="basic" className={`mb-4${section === "basic" ? "" : " d-none"}`}>
                            <Basic/>
                        </div>
                        <div id="spellbook" className={`mb-4${section === "spellbook" ? "" : " d-none"}`}>
